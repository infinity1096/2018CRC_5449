...
public class LifterToDown extends Command {
    ...
    protected void execute() {
    	...
    	output = range2(output,RobotMap.LIFTER_MINIMUM_POWER,RobotMap.LIFTER_MAXIMUM_POWER);
    	...
    	output *= VariablesToBeDetermined.LIFT_MOVE_OUTPUT_0;
    ...
    protected boolean isFinished() {
        boolean p1 =  Math.abs(RobotMap.LIFTER_DOWN_POSE - Robot.lifter.get_position()) < RobotMap.LIFTER_MAXIMUM_PASSING_ERROR;
        boolean p2 = false;
