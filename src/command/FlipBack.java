...
public class FlipBack extends Command{
	...
	private double time = 9999;
	 ...
	 protected void initialize() {
	    	...
	    	last_time = timer.get();
	    	error[0] = 0;
	    	error[1] = RobotMap.FLIP_BACK_POSE - Robot.flip.get_position_flip();
	    	is_down = (Robot.flip.get_position_flip() - RobotMap.FLIP_BACK_POSE)>=0;
	 }
	 ...
	 protected void execute() {
		 double P_output,D_output,dt,output;
	    	...
	    	error[0] = RobotMap.FLIP_BACK_POSE - Robot.flip.get_position_flip();
	    	P_output = error[0] * Kp;
	    	...
	    	if (is_down){
	    		output *= VariablesToBeDetermined.FLIP_MOVE_OUTPUT_1;
	    	}
	    	...
	    	//Robot.flip.move(output,balance_output);
	    	Robot.flip.move(output);
